...
public partial class MainPage
{
    ...
    bool isTapping;
    private Color playerOneColor = Colors.Red;
    private Color playerTwoColor = Colors.Blue;
    ...
    private async void OnChangePlayerOneColorButtonClicked(object sender, EventArgs e)
    {
        ...
        if (result != null)
        {
            playerOneColor = result;
            ((App)Application.Current).ChangePlayerOneColor(playerOneColor);
        }
    }

    private async void OnChangePlayerTwoColorButtonClicked(object sender, EventArgs e)
    {
        var colorPicker = new ColorPickerDialog();
        var result = await colorPicker.ShowAsync();
        ...
        if (result != null)
        {
            playerTwoColor = result;
            ((App)Application.Current).ChangePlayerTwoColor(playerTwoColor);
        }
    }
